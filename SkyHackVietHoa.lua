--[[
    ...
    to copy the code as it is written from zero by me 'DuongNgao'.
    ----------------------------------------------------------------------------
...
yellow = {
    ...
    },
    {
        "‍[️🧙]️Magic",
        content = {
            "[🔮]Không có phép thuật lấp lánh",
            "[✨]Phép thuật lấp lánh",
            "[🔁]Tự Động Đổi Áo Choàng",
            "[❌]Gỡ Tất Cả ",
        },
    },
    {
    ...
    },
    {
        "[🗃]Mode Menu",
        content = {
            "[🎥]Ghi lại bộ nhớ dùng chung",
            "[🧸]Biểu tượng và Kích thước đường viền",
            "[📸]Độ phân giải ScreenShot",
            "[⏲]Game Speed",
            "[☁️]Loại Bỏ Mây",
            "[💨]Loại Bỏ Gió[Phương Pháp  1]",
            "[💨]Loại Bỏ Gió[Phương Pháp 2]",
            "[📣]Tiếng kêu 'Phía khách hàng'",
            "[🌁]Filter Thung lũng ",
            "[🏁] Cải tiến Chạy",
            "[🏃🏻‍♂️]Delayed Hiệu ứng ",
        },  
...
Script By Dương ngu
zalo: 0375892307
Facebook: https://www.facebook.com/profile.php?id=100081167323338
            ]]
function offseter()
